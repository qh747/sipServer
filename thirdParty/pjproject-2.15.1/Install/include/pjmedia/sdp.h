...
struct pjmedia_sdp_session
{
    ...
    /** y field use for ssrc. y=ssrc
     * example: y=1432543123 
     */
    pj_str_t         gb28181_extend_y;

    /** f field use for media description. f=media type/pt/frame rate/width/height/bandwidth.
     *  example: f=v/2/25/960/720/20 
     */
    pj_str_t         gb28181_extend_f;

    /** u field use for uri. u=uri.
     *  example: u=34020000001320000001
     */
    pj_str_t         gb28181_extend_u;
};
